...
fn main() {
    ...
    // ==========================================================================
    let t0 = Instant::now();
    write_memory_efficient_results(&results, &bar_q_at_market_orders, &market_orders, "experiments/passive_impact/load_experiments/data/single/efficient/without").unwrap();
