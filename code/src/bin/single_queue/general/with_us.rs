...
fn main() {
    ...
    let process = if decoupled {
        ...
        let initial_state =
            AffineQueueProcess::stationary_state(initial_queue_size as f64, mu, &alpha, &beta);
    ...
    write_results(
        ...
        &q_at_market_orders,
        &market_orders,
        "experiments/passive_impact/load_experiments/data/single/general/with",
    )
    .unwrap();
    write_queue_samples(
        ...
        &q_at_market_orders,
        &market_orders,
        "experiments/queue_simulation/load_experiments/data/single/general/with",
    )
    .unwrap();
    write_queue_samples(
        &results.queue_samples,
        &q_at_market_orders,
        &market_orders,
        "experiments/queue_simulation/load_experiments/data/single/general",
    )
    .unwrap();
