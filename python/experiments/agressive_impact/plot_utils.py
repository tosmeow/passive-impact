...
def plot_shades(df, sim_prefix, title, ylabel, ref_col=None, save_path=None):
...
def plot_impact_by_event_type(impact_df, is_market, save_path=None):
...
def plot_queue_diff(queue_df, save_path=None):
