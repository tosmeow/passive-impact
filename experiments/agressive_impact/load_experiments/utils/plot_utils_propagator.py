...
DATA_BASE = LOAD_EXPERIMENT_DIR / 'data' / 'propagator'
...
def compute_plot_y_lims(counterfactual=False, data_base=None):
    """Return padded y-limits for the plots generated from one data set."""
    impact_df, queue_df, _is_market, _meta_end = load_data(
