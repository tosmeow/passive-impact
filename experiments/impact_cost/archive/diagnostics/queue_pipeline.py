...
class QueuePipelineConfig:
    ...
    parquet_path: str = "experiments/impact_cost/load_experiments/data/processed/factual_2025_05_29_esm5.parquet"
    output_dir: str = "experiments/impact_cost/archive/diagnostics/data/queue_pipeline"
