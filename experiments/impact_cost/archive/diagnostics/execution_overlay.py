...
class ExecutionOverlayConfig:
    ...
    output_dir: str = "experiments/impact_cost/archive/diagnostics/data/execution_overlay/passive_1s_stop15"
    image_dir: str = "experiments/impact_cost/archive/diagnostics/data/execution_overlay/images"
