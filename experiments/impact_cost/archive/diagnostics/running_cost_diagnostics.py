...
class RunningCostDiagnosticsConfig:
    ...
    cost_output_dir: str = "experiments/impact_cost/archive/diagnostics/data/impact_cost_latency_le_30s"
    output_dir: str = "experiments/impact_cost/archive/diagnostics/data/running_cost_diagnostics"
    raw_side: str = "A"
    queue_col: str = "q_b"
